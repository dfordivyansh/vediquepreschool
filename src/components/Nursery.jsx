      ...
      <div className="max-w-7xl mx-auto px-6 py-20">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-700 max-w-3xl mx-auto text-xl leading-relaxed">
            In Nursery, children move from purely visual and oral learning to the
            exciting beginning of their writing journey, while building strong
            foundations for primary school.
          </p>
        </div>
