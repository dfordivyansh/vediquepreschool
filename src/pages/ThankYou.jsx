...
const ThankYou = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Thank You | Vedique Preschool Hyderabad</title>

        <meta
          name="description"
          content="Thank you for submitting your enquiry to Vedique Preschool Hyderabad. Our team will contact you shortly."
        />

        {/* Important: Thank you pages should not be indexed */}
