    ...
    <>
      ...
      <section className="relative h-[70vh] w-full overflow-hidden">
        ...
        <button
          ...
          shadow-lg text-lg hover:scale-105 transition cursor-pointer"
        >
          ← Back to Home
        </button>
      ...
      {/* ===== GALLERY ===== */}
      <section
        className="py-16 px-4 sm:px-8 min-h-screen"
        style={{
          background:
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-14">
            {categories.map((cat) => (
              <button
                ...
                className={`px-6 py-2 rounded-full text-base sm:text-lg font-semibold transition cursor-pointer ${
                  activeCategory === cat
                    ? "bg-[#6B4FA3] text-white shadow-lg"
            ...
            <div className="flex justify-center gap-3 mt-14">
              {Array.from({ length: totalPages }).map((_, i) => (
                <button
                  ...
                  className={`w-10 h-10 rounded-full font-bold transition cursor-pointer ${
                    currentPage === i + 1
                      ? "bg-[#6B4FA3] text-white shadow-lg"
                      : "bg-white border border-[#6B4FA3]/30 text-[#6B4FA3]"
                  }`}
